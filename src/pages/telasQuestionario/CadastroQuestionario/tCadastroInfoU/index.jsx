...
export default function tCadastrarInfoU() {
    ...
    useEffect(() => {
        ...
        checkFormCompletion();
    }, [nome, sobrenome, cpf, celular, email, senha, dia, mes, ano]);

    function handleNavigate() {
        const dataNasc = `${ano}-${mes}-${dia}`;
        navigation.navigate('tCadastroLocalU', {
            nome: nome, sobrenome: sobrenome, celular: celular, cpf: cpf, email: email, senha: senha, sexo: sexo, data_de_nasc: dataNasc
        });
    }
